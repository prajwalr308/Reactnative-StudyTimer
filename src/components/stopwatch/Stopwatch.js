...
const Stopwatch = () => {
    ...
    return (
        ...
        timeToShow={[ 'H', 'M', 'S']}
      />
    {pause?  <TouchableOpacity style={styles.buttonContainerPause} onPress={()=>{
          setpause(!pause);
      }} title="pause"><Text style={{color:"white"}}>Pause</Text></TouchableOpacity>:<TouchableOpacity style={styles.buttonContainerPlay} onPress={()=>{
        setpause(!pause);
    }} title="pause"><Text style={{color:"white"}}>Start</Text></TouchableOpacity>}
      <View>
      <Slider
      style={styles.slider}
        maximumValue={13}
      ...
      <TouchableOpacity style={styles.buttonContainerPlay}  onPress={()=>{setHours(timeState)}}><Text style={{color:"white"}} >set time</Text></TouchableOpacity>
